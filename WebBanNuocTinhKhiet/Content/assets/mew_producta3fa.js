...
var selectCallback = function(variant, selector) {
	...
	if (variant !== null) {
		...
		if(variant.available){
			...
			button.removeClass('d-none').addClass('d-out');
		...
		if (variant.featured_image) {  
			let variantImg = variant.featured_image.src.replace('/https:|http:|\s/g', '');
			$(".product-main-slide img").each(function(){
				let currentUrlImg = $(this).attr('data-zoom-image').replace('/https:|http:|\s/g', '');
